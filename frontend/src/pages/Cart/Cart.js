            ...
            <div className='content-container'>
                        ...
                        <div className='cart-item-container'>
                            {inventory.length === 0 || quantity === 0 ? 
                                <div className='empty-container'>
                                    ...
                                    <p>You didn't add any item in your cart yet. Browse the website to find amazing deals!</p>
                                    <Link to = '/' className='button'>Browse games</Link>
                                </div> : 
                ...
                <div className='right-container'>
                    ...
                    <div className='summary-container'>
                        ...
                        <Link to = '/' className='back'><BsArrowLeftCircle className='icon'></BsArrowLeftCircle>Continue shopping</Link>
                    </div>
                </div>
            </div>
        </div>
