  ...
  return (
    <div className="faq-container">
      <ol className="paragraph-container">
        ...
        <li className="paragraph-item p-list">
          <h3 className="p-header">{t('faq-question-4')}</h3>
          <p>
            {t('faq-answer-4.1')}
            <br />
            {t('faq-answer-4.2')}
        ...
        <li className="paragraph-item p-list">
          <h3 className="p-header">{t('faq-question-5')}</h3>
          <p>{t('faq-answer-5.1')}</p>
          <br />
          <p>{t('faq-answer-5.2')}</p>
        </li>
        <li className="paragraph-item p-list">
          <h3 className="p-header">{t('faq-question-6')}</h3>
          <p>{t('faq-answer-6')}</p>
        </li>
        <li className="paragraph-item p-list">
        ...
        <li className="paragraph-item p-list">
          <h3 className="p-header">{t('faq-question-14')}</h3>
          <h4>{t('faq-answer-14.1')}</h4>
          <p>{t('faq-answer-14.2')}</p>
          <br />
          <h4>{t('faq-answer-14.3')}</h4>
          <p>{t('faq-answer-14.4')}</p>
          <br />

          <h4>{t('faq-answer-14.5')}</h4>
          <p>{t('faq-answer-14.6')}</p>
        </li>
        <li className="paragraph-item p-list">
